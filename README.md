...
Check out the website: [React Crypto App](https://www.blabla.com/)
...
I wanted to create a React Crypto App where we will be using the Coin Gecko API to access real time cryptocurrency information and data to display on this website.
